# Upload and library workflows

This guide covers additions on the main branch. Check the release notes for features in a stable installer. Verification status is tracked in [feature acceptance](../desktop/features-qa.md).
